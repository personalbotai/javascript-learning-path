...
**Slug**: `encapsulation-getter-setter` · **Level**: Intermediate · **Waktu**: 20 Menit

## 🎯 Tujuan Pembelajaran
Memahami konsep fundamental, implementasi praktis, serta best practice dari **Encapsulation Getter Setter** dalam pengembangan JavaScript modern.
...
### 1. Konsep Utama
Dalam JavaScript modern (ES6+), `Encapsulation Getter Setter` memegang peranan krusial untuk menghasilkan kode yang bersih, efisien, dan mudah dirawat.
...
const demo = {
    topik: 'Encapsulation Getter Setter',
    status: 'aktif',
...
2. Buat fungsi utilitas sederhana yang menerapkan konsep `Encapsulation Getter Setter`
